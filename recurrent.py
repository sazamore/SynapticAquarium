# -*- coding: utf-8 -*-
"""
Created on Wed Mar 26 08:22:23 2014
...
Iext = np.random.rand(N)*2   #Iext= np.zeros(N)      # externally applied stimulus
#Iext[0] = 1.5           # intial value
...
np.fill_diagonal(synapses,0)   #no self-connectivity
